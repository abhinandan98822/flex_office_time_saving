    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('H', 'HR Department'), ('A', 'Admin'), ('F', 'Staff'), ('E', 'Employee')], default='E', max_length=1)),
                ('full_name', models.CharField(max_length=200)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('photo', models.ImageField(default='default/avatar.jpg', upload_to='')),
                ('office_email', models.EmailField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timespent', models.CharField(blank=True, max_length=100, null=True)),
